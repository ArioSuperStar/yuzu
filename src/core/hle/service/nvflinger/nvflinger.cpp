...
constexpr auto frame_ticks = static_cast<s64>(Core::Timing::BASE_CLOCK_RATE / 60);
long long unsigned int frame_ticks_30fps = (Core::Timing::BASE_CLOCK_RATE / Settings::values.fps_mode);
